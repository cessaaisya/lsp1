            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">Deliveries</h1>
                            ...
                            <a class="btn btn-primary" href="{{ route('deliveries.create')}}" role="button">Add New Item</a>
                            <br><br>
                    <!-- Table -->
...
<div class="table-responsive p-0">
                ...
                <form action="{{route('deliveries.update', $deliveries)}}" method="POST" id="deliveries">
                @method('PUT')
                @csrf
                    ...
                    <label for="orderid"class="form-label">Order id</label>
                     ...
                     <div class="mb-3 ms-3 me-3">
                        <label type="nama" class="form-label">Shipping Date</label>
                        <input type="date" name="shipping_date" id="shippingdate" class="form-control" aria-label="tanggal" value="{{$deliveries->shipping_date ?? old('shipping_date')}}" required>
                     </div>
                     <div class="mb-3 ms-3 me-3">
                        <label type="nama" class="form-label">Tracking Code</label>
                        <input type="text" name="tracking_code" id="tcode" class="form-control" aria-label="tcode" value="{{$deliveries->tracking_code ?? old('tracking_code')}}" required>
                     </div>
                     <div class="mb-3 ms-3 me-3">
                        <label type="Status"class="form-label">Status</label>
                        <input type="text" id="status" name="status" class="form-control" aria-label="status" placeholder="enter your status" value="{{$deliveries->status ?? old('status')}}" required>
                     </div>
