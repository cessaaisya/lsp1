          ...
          <div class="card mb-6">
            ...
            <!-- FORM -->
              <div class="table-responsive p-0">
                ...
                <form action='/insertdeliveries' method="POST" id="frmDeli">
                  @csrf
                    ...
                    <label for="orderid"class="form-label">Order id</label>
                     ...
                     <div class="mb-3 ms-3 me-3">
                        ...
                        <input type="date" id="shipping_date" name="shipping_date" class="form-control" placeholder="Enter Your shipping date" aria-label="shippingdate">
                     </div>
                     <div class="mb-3 ms-3 me-3">
                        <label for="trackingcode"class="form-label">Tracking Code</label>
                        <input type="text" id="tracking_code" name="tracking_code" class="form-control" placeholder="Enter Your tracking code" aria-label="trackingcode">
                     </div>
                     <div class="mb-3 ms-3 me-3">
