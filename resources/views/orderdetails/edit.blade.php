          ...
          <div class="card mb-6">
            ...
            <!-- FORM -->
              <div class="table-responsive p-0">
                ...
                <form action="{{route('orderdetails.update', $orderdetails)}}" method="POST" id="frmorderdetails">
                @method('PUT')
                @csrf
                     <div class="mb-3 ms-3 me-3">
                        <label for="productid"class="form-label">Product id</label>
                        <input type="text" id="product_id" name="product_id" class="form-control" value="{{$orderdetails->product_id ?? old('product_id')}}" required>
                     </div>
                     <div class="mb-3 ms-3 me-3">
                     ...
                     <div class="mb-3 ms-3 me-3">
                        ...
                        <input type="text" id="quantity" name="quantity" class="form-control" value="{{$orderdetails->quantity ?? old('quantity')}}" required>
                     </div>
                     <div class="mb-3 ms-3 me-3">
                        <label for="subtotal"class="form-label">Subtotal</label>
                        <input type="text" id="subtotal" name="subtotal" class="form-control" value="{{$orderdetails->subtotal ?? old('subtotal')}}" required>
                     </div>
