            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">Order Detail</h1>
                            ...
                            <a class="btn btn-primary" href="{{ route('orderdetails.create')}}" role="button">Add New Item</a>
                            <br><br>
                    <!-- Table -->
          ...
          <div class="card mb-6">
            ...
            <!-- FORM -->
              <div class="table-responsive p-0">
                ...
                <form action='/insertorderdetails' method="POST" id="frmorderdetails">
                  @csrf
                     <div class="mb-3 ms-3 me-3">
                        <label for="productid"class="form-label">Product id</label>
                        <input type="text" id="product_id" name="product_id" class="form-control" placeholder="Enter Your productid" aria-label="productid">
                     </div>
                     <div class="mb-3 ms-3 me-3">
                     ...
                     <div class="mb-3 ms-3 me-3">
                        ...
                        <input type="text" id="quantity" name="quantity" class="form-control" placeholder="Enter Your quantity" aria-label="quantity">
                     </div>
                     <div class="mb-3 ms-3 me-3">
                        <label for="subtotal"class="form-label">Subtotal</label>
                        <input type="text" id="subtotal" name="subtotal" class="form-control" placeholder="Enter Your subtotal" aria-label="subtotal">
                     </div>
                     <div class="row ms-3 me-3 justify-content-end">
                        <div class="col-3">
                        <button type="submit" class="btn btn-primary" id="save">Save</button>
                        <a href="{{ route('orderdetails.index') }}" class="btn btn-danger">Cancel</a>
                    </div>
                    </div>
          </div>
          </div> 
