            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">Payment</h1>
                            ...
                            <a class="btn btn-primary" href="{{ route('payments.create')}}" role="button">Add New Item</a>
                            <br><br>
                    <!-- Table -->
          ...
          <div class="card mb-6">
            ...
            <!-- FORM -->
              <div class="table-responsive p-0">
                ...
                <form action="{{route('payments.update', $payments)}}" method="POST" id="frmPay">
                @method('PUT')
                @csrf
                     ...
                     <div class="mb-3 ms-3 me-3">
                        ...
                        <input type="date" id="payment_date" name="payment_date" class="form-control" value="{{$payments->payment_date ?? old('payment_date')}}" required>
                     </div>
                     <div class="mb-3 ms-3 me-3">
                     <label for="payment_method" class="form-label">Payment Method</label>
                    <br>
                     <select class="form-control" aria-label="Default select example" id="payment_method" name="payment_method" required>
                        <option value="{{$payments->payment_method ?? old('payment_method')}}">{{$payments->payment_method ?? old('payment_method')}}</option>
                        <option value="admin">Cash</option>
                        <option value="owner">Transfer</option>
                        </select>
                     </div>
                     
                     <div class="mb-3 ms-3 me-3">
                        <label for="amount"class="form-label">Amount</label>
                        <input type="text" id="amount" name="amount" class="form-control" value="{{$payments->amount ?? old('amount')}}" required>
                     </div>
