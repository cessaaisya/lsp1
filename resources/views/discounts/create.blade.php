          ...
          <div class="card mb-6">
            ...
            <!-- FORM -->
              <div class="table-responsive p-0">
                ...
                <form action='/insertdiscounts' method="POST" id="frmCust">
                  @csrf
                     ...
                     <div class="mb-3 ms-3 me-3">
                        ...
                        <input type="date" id="start_date" name="start_date" class="form-control" placeholder="Enter Your start date" aria-label="start_date">
                     </div>
                     <div class="mb-3 ms-3 me-3">
                        <label for="end_date"class="form-label">end date</label>
                        <input type="date" id="end_date" name="end_date" class="form-control" placeholder="Enter Your end date" aria-label="end_date">
                     </div>
                     <div class="mb-3 ms-3 me-3">
                        <label for="percentage"class="form-label">Percentage</label>
                        <input type="text" id="percentage" name="percentage" class="form-control" placeholder="Enter Your percentage" aria-label="percentage">
                     </div>
