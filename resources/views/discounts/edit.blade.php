            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">Discount</h1>
                            ...
                            <a class="btn btn-primary" href="{{ route('discounts.create')}}" role="button">Add New Item</a>
                            <br><br>
                    <!-- Table -->
          ...
          <div class="card mb-6">
            ...
            <!-- FORM -->
              <div class="table-responsive p-0">
                ...
                <form action="{{route('discounts.update', $discounts)}}" method="POST" id="frmCust">
                @method('PUT')
                @csrf
                     <div class="mb-3 ms-3 me-3">
                     <label for="category_discount_id" class="form-label">category discount id</label>
                        <br>
                        <select name="category_discount_id" id="category_discount_id" class="form-control">
                            <option value="" required>
                                @foreach($discountcategories as $d)
                     ...
                     <div class="mb-3 ms-3 me-3">
                        ...
                        <input type="date" id="start_date" name="start_date" class="form-control" value="{{$discounts->start_date ?? old('start_date')}}" required>
                     </div>
                     <div class="mb-3 ms-3 me-3">
                        <label for="end_date"class="form-label">end date</label>
                        <input type="date" id="end_date" name="end_date" class="form-control" value="{{$discounts->end_date ?? old('end_date')}}" required>
                     </div>
                     <div class="mb-3 ms-3 me-3">
                        <label for="percentage"class="form-label">Percentage</label>
                        <input type="text" id="percentage" name="percentage" class="form-control" value="{{$discounts->percentage ?? old('percentage')}}" required>
                     </div>
