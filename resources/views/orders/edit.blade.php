            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">Order</h1>
                            ...
                            <a class="btn btn-primary" href="{{ route('orders.create')}}" role="button">Add New Item</a>
                            <br><br>
                    <!-- Table -->
          ...
          <div class="card mb-6">
            ...
            <!-- FORM -->
              <div class="table-responsive p-0">
                ...
                <form action="{{route('orders.update', $orders)}}" method="POST" id="frmOrders">
                @method('PUT')
                @csrf
                     ...
                     <div class="mb-3 ms-3 me-3">
                                ...
                                <select class="form-control" id="customer_id" name="customer_id" >
                                    ...
                                    @foreach ($customer as $c)
                                        <option class="form-control" value="{{ $c->id }}" {{ $orders->customer_id == $c->id ? 'selected' : '' }}>{{ $c->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                     <div class="mb-3 ms-3 me-3">
                        <label for="date" class="form-label">Order Date</label>
                        <input type="date" id="order_date" name="order_date" class="form-control" value="{{$orders->order_date ?? old('order_date')}}" required>
                     </div>
                     <div class="mb-3 ms-3 me-3">
                        <label for="total"class="form-label">Total Amount</label>
                        <input type="text" id="total_amount" name="total_amount" class="form-control" value="{{$orders->total_amount ?? old('total_amount')}}" required>
                     </div>
                     <div class="mb-3 ms-3 me-3">
                        <label for="status"class="form-label">Status</label>
                        <input type="text" id="status" name="status" class="form-control" value="{{$orders->status ?? old('status')}}" required>
                     </div>
