          ...
          <div class="card mb-6">
            ...
            <!-- FORM -->
              <div class="table-responsive p-0">
                ...
                <form action='/insertdisccat' method="POST" id="frmdisccat">
                  @csrf
                    <div class="mb-3 ms-3 me-3">
                        <label for="name" class="form-label">Category's Name</label>
                        <input type="name" name="category_name" id="category_name" class="form-control" placeholder="Enter Your Category's Name" aria-label="name">
                     </div>
