        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Discount Categories</h1>
                            <div class="card mb-4">
                            <div class="card-header pb-0">
                            <a class="btn btn-primary" href="{{ route('discountcategories.create')}}" role="button">Add New Item</a>
                            <br><br>
                    <!-- Table -->
        ...
        <div class="col-12">
          <div class="card mb-6">
            <div class="card-header pb-2">
              <h6>Form Discount Categories</h6>
            </div>
            ...
            <!-- FORM -->
              <div class="table-responsive p-0">
                ...
                <form action="{{route('discountcategories.update', $discountcategories)}}" method="POST" id="frmdisccat">
                @method('PUT')
                @csrf
                    <div class="mb-3 ms-3 me-3">
                        <label for="name" class="form-label">Category's Name</label>
                        <input type="name" name="category_name" id="category_name" class="form-control" value="{{$discountcategories->category_name ?? old('category_name')}}" required>
                     </div>
                     <div class="row ms-3 me-3 justify-content-end">
                        <div class="col-3">
                        <button type="submit" class="btn btn-primary" id="save">Save</button>
                        <a href="{{ route('discountcategories.index') }}" class="btn btn-danger">Cancel</a>
                    </div>
                    </div>
          </div>
          </div> 
