          ...
          <div class="card mb-6">
            ...
            <!-- FORM -->
              <div class="table-responsive p-0">
                ...
                <form action='/insertproductreviews' method="POST" id="frmprodrev">
                  @csrf
                     ...
                     <div class="mb-3 ms-3 me-3">
                        ...
                        <input type="text" id="rating" name="rating" class="form-control" placeholder="Enter Your rating" aria-label="rating">
                     </div>
                     <div class="mb-3 ms-3 me-3">
                        <label for="comment"class="form-label">Comment</label>
                        <input type="text" id="comment" name="comment" class="form-control" placeholder="Enter Your comment" aria-label="comment">
                     </div>
