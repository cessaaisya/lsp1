            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">Product Review</h1>
                            ...
                            <a class="btn btn-primary" href="{{ route('productreviews.create')}}" role="button">Add New Item</a>
                            <br><br>
                    <!-- Table -->
          ...
          <div class="card mb-6">
            ...
            <!-- FORM -->
              <div class="table-responsive p-0">
                ...
                <form action="{{route('productreviews.update', $productreviews)}}" method="POST" id="frmprodrev">
                @method('PUT')
                @csrf
                     ...
                     <div class="mb-3 ms-3 me-3">
                        ...
                        <input type="text" id="rating" name="rating" class="form-control" placeholder="Enter Your rating" aria-label="rating" value="{{$productreviews->rating ?? old('rating')}}" required>
                     </div>
                     <div class="mb-3 ms-3 me-3">
                        <label for="comment"class="form-label">Comment</label>
                        <input type="text" id="comment" name="comment" class="form-control" placeholder="Enter Your comment" aria-label="comment" value="{{$productreviews->comment ?? old('comment')}}" required>
                     </div>
                     <div class="row ms-3 me-3 justify-content-end">
                        <div class="col-3">
                        <a href="{{ route('productreviews.index') }}" class="btn btn-danger">Cancel</a>
