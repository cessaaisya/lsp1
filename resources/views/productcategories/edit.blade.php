            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">Product Categories</h1>
                            ...
                            <a class="btn btn-primary" href="{{ route('productcategories.create')}}" role="button">Add New Item</a>
                            <br><br>
                    <!-- Table -->
          ...
          <div class="card mb-6">
            ...
            <!-- FORM -->
              <div class="table-responsive p-0">
                ...
                <form action="{{route('productcategories.update', $productcategories)}}" method="POST" id="frmprocat">
                @method('PUT')
                @csrf
                    <div class="mb-3 ms-3 me-3">
                        <label for="name" class="form-label">Category's Name</label>
                        <input type="name" name="category_name" id="category_name" class="form-control" value="{{$productcategories->category_name ?? old('category_name')}}" required>
                     </div>
                     <div class="row ms-3 me-3 justify-content-end">
                        <div class="col-3">
                        <button type="submit" class="btn btn-primary" id="save">Save</button>
                        <a href="{{ route('productcategories.index') }}" class="btn btn-danger">Cancel</a>
                    </div>
                    </div>
          </div>
          </div> 
