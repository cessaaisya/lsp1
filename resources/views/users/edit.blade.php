          ...
          <div class="card mb-6">
            ...
            <!-- FORM -->
              <div class="table-responsive p-0">
                ...
                <form action="{{ route('users.update', $users)}}" method="POST" id="users">
                @method('PUT')
                @csrf
                    <div class="mb-3 ms-3 me-3">
                        <label for="name" class="form-label">User's Name</label>
                        <input type="text" name="name" id="name" class="form-control" value="{{$users->name ?? old('name')}}" required>
                     </div>
                     <div class="mb-3 ms-3 me-3">
                        <label for="email"class="form-label">Email</label>
                        <input type="email" id="email" name="email" class="form-control" value="{{$users->email ?? old('email')}}" required>
                     </div>
                     <div class="mb-3 ms-3 me-3">
                        <label for="password"class="form-label">Password</label>
                        <input type="password" id="password" name="password" class="form-control" value="{{$users->password ?? old('password')}}" required>
                     </div>
                     <div class="mb-3 ms-3 me-3">
                     ...
                     <div class="mb-3 ms-3 me-3">
                        ...
                        <input type="aktif" id="aktif" name="aktif" class="form-control" value="{{$users->aktif ?? old('aktif')}}" required>
                     </div>
