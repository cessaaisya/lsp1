        ...
        <div class="col-12">
          <div class="card mb-6">
            ...
            <div class="table-responsive p-0">
                ...
                <form action="{{route('products.update', $products->id)}}" method="POST" id="products" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <!-- <div class="mb-3 ms-3 me-3">
                     ...
                     <div class="mb-3 ms-3 me-3">
                                ...
                                <select class="form-control" id="product_category_id" name="product_category_id" >
                                    ...
                                    @foreach ($productCategory as $pc)
                                        <option class="form-control" value="{{ $pc->id }}" {{ $products->product_category_id == $pc->id ? 'selected' : '' }}>{{ $pc->category_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                     <div class="mb-3 ms-3 me-3">
                        <label type="nama" class="form-label">Product Name</label>
                        <input type="text" name="product_name" id="productname" class="form-control" placeholder="masukkan nama product anda" aria-label="password"  value="{{ $products->product_name }}">
                     </div>
                     <div class="mb-3 ms-3 me-3">
                        <label type="deskripsi" class="form-label hidden">Description</label>
                        <textarea rows="5" name="description" id="description" class="form-control" placeholder="tambahkan deskripsi product" aria-label="name">{{ $products->description }}</textarea>
                     </div>
                     <div class="mb-3 ms-3 me-3">
                        <label type="subtotal"class="form-label">Price</label>
                        <input type="number" id="price" name="price" class="form-control" aria-label="price"  value="{{ $products->price }}">
                     </div>
                     <div class="mb-3 ms-3 me-3">
                        <label type="subtotal"class="form-label">Stock Quantity</label>
                        <input type="number" id="stok_quantity" name="stok_quantity" class="form-control" aria-label="squantity"  value="{{ $products->stok_quantity }}">
                     </div>
                     <!-- <div class="mb-3 ms-3 me-3">
