          ...
          <div class="card mb-6">
            ...
            <!-- FORM -->
              <div class="table-responsive p-0">
                ...
                <form action="/store" method="POST" id="frmproduct" enctype="multipart/form-data">
                  @csrf
                     ...
                     <div class="mb-3 ms-3 me-3">
                        ...
                        <input type="text" id="product_name" name="product_name" class="form-control" placeholder="Enter Your product name" aria-label="product_category_id">
                     </div>
                     <div class="mb-3 ms-3 me-3">
                        <label for="description"class="form-label">Description</label>
                        <input type="description" id="description" name="description" class="form-control" placeholder="Enter Your description" aria-label="description">
                     </div>
                     <div class="mb-3 ms-3 me-3">
                        <label for="price"class="form-label">Price</label>
                        <input type="price" id="price" name="price" class="form-control" placeholder="Enter Your price" aria-label="price">
                     </div>
                     <div class="mb-3 ms-3 me-3">
                        <label for="stok_quantity"class="form-label">Stock Quantity</label>
                        <input type="stok_quantity" id="stok_quantity" name="stok_quantity" class="form-control" placeholder="Enter Your stok quantity" aria-label="stok_quantity">
                     </div>
                     <div class="mb-3 ms-3 me-3">
                        <label for="image1"class="form-label">image 1</label>
                        <input type="file" id="image1_url" name="image1_url" class="form-control" placeholder="Enter Your image1" aria-label="image1">
                     </div>
                     <div class="mb-3 ms-3 me-3">
                     ...
                     <div class="mb-3 ms-3 me-3">
                        ...
                        <input type="file" id="image4_url" name="image4_url" class="form-control" placeholder="Enter Your image4" aria-label="image4">
                     </div>
                     <div class="mb-3 ms-3 me-3">
                        <label for="image5"class="form-label">image 5</label>
                        <input type="file" id="image5_url" name="image5_url" class="form-control" placeholder="Enter Your image5" aria-label="image5">
                     </div>
