          ...
          <div class="card mb-6">
            ...
            <!-- FORM -->
              <div class="table-responsive p-0">
                ...
                <form action='/insertcustomers' method="POST" id="frmCust">
                  @csrf
                    <div class="mb-3 ms-3 me-3">
                     ...
                     <div class="mb-3 ms-3 me-3">
                        ...
                        <input type="phone" id="phone" name="phone" class="form-control" placeholder="Enter Your Phone" aria-label="phone">
                     </div>
                     <div class="mb-3 ms-3 me-3">
