            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">Customer</h1>
                            ...
                            <a class="btn btn-primary" href="{{ route('customers.create')}}" role="button">Add New Item</a>
                            <br><br>
                    <!-- Table -->
          ...
          <div class="card mb-6">
            ...
            <!-- FORM -->
              <div class="table-responsive p-0">
                ...
                <form action="{{route('customers.update', $customers)}}" method="POST" id="customers">
                @method('PUT')
                @csrf
                    <div class="mb-3 ms-3 me-3">
                        <label for="name" class="form-label">Customer's Name</label>
                        <input type="text" name="name" id="name" class="form-control" value="{{$customers->name ?? old('name')}}" required>
                     </div>
                     <div class="mb-3 ms-3 me-3">
                        <label for="email"class="form-label">Email</label>
                        <input type="email" id="email" name="email" class="form-control" value="{{$customers->email ?? old('email')}}" required>
                     </div>
                     <div class="mb-3 ms-3 me-3">
                        <label for="password"class="form-label">Password</label>
                        <input type="password" id="password" name="password" class="form-control" value="{{$customers->password ?? old('password')}}" required>
                     </div>
                     <div class="mb-3 ms-3 me-3">
                        <label for="phone"class="form-label">phone</label>
                        <input type="phone" id="phone" name="phone" class="form-control" value="{{$customers->phone ?? old('phone')}}" required>
                     </div>
                     <div class="mb-3 ms-3 me-3">
                        <label for="address1"class="form-label">1st Address</label>
                        <input type="address1" id="address1" name="address1" class="form-control" value="{{$customers->address1 ?? old('address1')}}" required>
                     </div>
                     <div class="mb-3 ms-3 me-3">
                        <label for="address2"class="form-label">2nd Address</label>
                        <input type="address2" id="address2" name="address2" class="form-control" value="{{$customers->address2 ?? old('address2')}}" required>
                     </div>
                     <div class="mb-3 ms-3 me-3">
                        <label for="address3"class="form-label">3rd Address</label>
                        <input type="address3" id="address3" name="address3" class="form-control" value="{{$customers->address3 ?? old('address3')}}" required>
                     </div>
